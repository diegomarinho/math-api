...
import static br.com.dma.math.infra.rabbitmq.RabbitMQAsyncMessageProducer.PERSISTENCE_FALLBACK;
import static br.com.dma.math.infra.rabbitmq.RabbitMQAsyncMessageProducer.SEARCH_ADDRESS;

import br.com.dma.math.aop.LogExecutionInfo;
import br.com.dma.math.infra.api.AsyncMessageProducer;
import br.com.dma.math.infra.mongodb.AsyncMessageFallbackEntity;
import br.com.dma.math.infra.mongodb.AsyncMessageFallbackRepository;
import br.com.dma.math.infra.rabbitmq.RabbitMQAsyncMessageProducer;
